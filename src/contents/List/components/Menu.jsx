...
const Menu = ({ setShowFilter }) => (
  <div className="md:hidden block sticky top-0 z-10 dark:bg-black bg-white">
    <div className="border-b grid grid-cols-2 divide-x py-2">
      <button
        type="button"
        className="py-2 gap-2 flex items-center justify-center"
